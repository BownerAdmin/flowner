...
import 'recipe_tile_model.dart';
export 'recipe_tile_model.dart';
...
class RecipeTileWidget extends StatefulWidget {
  ...
  @override
  _RecipeTileWidgetState createState() => _RecipeTileWidgetState();
}

class _RecipeTileWidgetState extends State<RecipeTileWidget>
    with TickerProviderStateMixin {
  late RecipeTileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecipeTileModel());
