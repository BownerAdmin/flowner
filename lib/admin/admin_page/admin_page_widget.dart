import '/admin/attribute_property_modal/attribute_property_modal_widget.dart';
...
class _AdminPageWidgetState extends State<AdminPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (_model.currentUser!.isAdmin) {
        return;
      }

      context.goNamed('OwnerPage');
    ...
    return StreamBuilder<List<PropertiesRecord>>(
      stream: queryPropertiesRecord(
        queryBuilder: (propertiesRecord) =>
            propertiesRecord.orderBy('property_id', descending: true),
      ),
      builder: (context, snapshot) {
        ...
        List<PropertiesRecord> adminPagePropertiesRecordList = snapshot.data!;
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: Align(
                ...
                child: Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(300.0, 100.0, 300.0, 0.0),
                      ...
                      children: [
                        Align(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                'Nombre de nouveaux biens à créer : ',
                              ...
                              Container(
                                ...
                                child: FlutterFlowCountController(
                                  ...
                                  count: _model.countControllerValue ??=
                                      _model.createPropertiesIteration,
                              ...
                              FFButtonWidget(
                                onPressed: _model.countControllerValue == 0
                                    ...
                                    : () async {
                                            ...
                                            return numbers.reduce(
                                                (currentMax, next) =>
                                                    currentMax > next
                                                        ? currentMax
                                                        : next);
                                          }(adminPagePropertiesRecordList
                                                  .map((e) => e.propertyId)
                                                  .toList());
                                        });
                                        setState(() {
                                          _model.firstNewPropertyId =
                                              _model.firstNewPropertyId! + 1;
                                        });
                                        while (
                                            _model.createPropertiesIteration <
                                        ...
                                        setState(() {
                                          _model.createPropertiesIteration = 0;
                                        });
                                      },
                                text: 'Créer les biens',
                                options: FFButtonOptions(
                                  ...
                                  borderRadius: BorderRadius.circular(8.0),
                                  disabledColor: Color(0x88005297),
                                ),
                              ),
                        ...
                        Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final properties =
                                  adminPagePropertiesRecordList.toList();
